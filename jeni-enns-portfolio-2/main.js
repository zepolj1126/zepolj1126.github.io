...
//Get the back-up button
let backUpBtn = document.querySelectorAll(".scrollBackUpBtn");
...
function scrollFunction() {
    ...
    for (let i = 0; i < backUpBtn.length; i++) {
...
function aboutMePageTiles() {

    let tiles = document.querySelectorAll(".about-me-page-tile");

    for (let i = 0; i < tiles.length; i++) {
        tiles[i].addEventListener("click", function () {
            let overlay = this.querySelector(".about-me-tile-overlay");
            overlay.classList.toggle("show-about-me-tile-overlay");
        });
    }

}

function workSampleImages() {
    ...
    for (let i = 0; i < img.length; i++) {
        img[i].addEventListener("click", function () {
            ...
            modalContent.setAttribute("src", this.src);
        });
    }
